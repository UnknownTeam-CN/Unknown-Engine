...
class PlayState extends MusicBeatState
{
	...
	// 鍏紑鐨勬瓕鏇查暱搴?getter 鈥?Unknown Engine
	...
	private var _songLength:Float = 0; // 鍐呴儴瀛樺偍
	...
	public var replayInputFrames:Array<ReplayFrameData> = []; // 帧级按键录制
	public var replayInputIndex:Int = 0;                       // 回放时当前帧索引
	public static var beatHitData:Array<Array<Dynamic>> = [];

	// ResultsScreen 鏁版嵁浼犻€?鈥?Unknown Engine
	...
	override public function create()
	{
		...
		if (loadRep && rep != null && rep.replay != null)
		{
			try
			{
				...
				// 若 _replayPath 为空，尝试从 replays/jsons/songname/ 目录搜索匹配的 JSON 文件
