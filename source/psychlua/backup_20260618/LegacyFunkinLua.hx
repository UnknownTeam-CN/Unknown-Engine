	...
	public function new(script:String) {
		...
		Lua_helper.add_callback(lua, "addLuaScript", function(luaFile:String, ?ignoreAlreadyRunning:Bool = false) { //would be dope asf.
			...
			if(doPush)
			{
				...
				PlayState.instance.luaArray.push(new LegacyFunkinLua(cervix));
				return;
			}
		...
		Lua_helper.add_callback(lua, "makeLuaSprite", function(tag:String, image:String, x:Float, y:Float) {
			tag = tag.replace('.', '');
			resetSpriteTag(tag);
			var leSprite:ModchartSprite = new LegacyModchartSprite(x, y);
...
class LegacyLegacyModchartSprite extends FlxSprite
{
...
class LegacyLegacyModchartText extends FlxText
{
	public var wasAdded:Bool = false;
...
class LegacyLegacyDebugLuaText extends FlxText
{
