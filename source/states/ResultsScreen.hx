...
class ResultsScreen extends MusicBeatState
{
	...
	override function create()
	{
		...
		// 名称 — 先隐藏，打乱结束后显示（Story Mode 显示 Week 名称，Freeplay 显示歌曲名）
		var displayName:String;
		if (PlayState.isStoryMode)
			displayName = (PlayState.storyWeekName != null && PlayState.storyWeekName != "") ? PlayState.storyWeekName : "Week";
		else
			displayName = PlayState.SONG != null ? PlayState.SONG.song : "Unknown";
		songTitleText = new FlxText(20, 60, 0, displayName, 32);
