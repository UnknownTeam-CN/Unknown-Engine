...

{
...

	{
		...
		DiscordClient.changePresence(Language.getPhrase('stage_discord_title', 'Stage Editor'), 'Stage: ' + lastLoadedStage);
...

	{
		...
		var tipText:FlxText = new FlxText(0, FlxG.height - 44, 300, Language.getPhrase('stage_help_f1', 'Press F1 for Help'), 20);
		...
		var targetTxt:FlxText = new FlxText(30, FlxG.height - 52, 300, Language.getPhrase('stage_camera_target', 'Camera Target'), 16);
		...
		focusRadioGroup = new PsychUIRadioGroup(targetTxt.x, FlxG.height - 24, [Language.getPhrase('stage_camera_dad', 'dad'), Language.getPhrase('stage_camera_boyfriend', 'boyfriend'), Language.getPhrase('stage_camera_gf', 'gf')], 10, 0, true);
		...
		lowQualityCheckbox = new PsychUICheckBox(FlxG.width - 240, FlxG.height - 36, Language.getPhrase('stage_can_see_low', 'Can see Low Quality Sprites?'), 90);
		...
		highQualityCheckbox = new PsychUICheckBox(FlxG.width - 120, FlxG.height - 36, Language.getPhrase('stage_can_see_high', 'Can see High Quality Sprites?'), 90);
...

	{
		...
		var buttonMoveUp:PsychUIButton = new PsychUIButton(buttonX, buttonY, Language.getPhrase('stage_move_up', 'Move Up'), function()
		...
		var buttonMoveDown:PsychUIButton = new PsychUIButton(buttonX, buttonY + 30, Language.getPhrase('stage_move_down', 'Move Down'), function()
		...
		var buttonCreate:PsychUIButton = new PsychUIButton(buttonX, buttonY + 60, Language.getPhrase('stage_new_btn', 'New'), function() createPopup.visible = createPopup.active = true);
		...
		var buttonDuplicate:PsychUIButton = new PsychUIButton(buttonX, buttonY + 90, Language.getPhrase('stage_duplicate', 'Duplicate'), function()
		...
		var buttonDelete:PsychUIButton = new PsychUIButton(buttonX, buttonY + 120, Language.getPhrase('stage_delete', 'Delete'), function()
...

	{
		...
		var txt:FlxText = new FlxText(0, bg.y + 10, 180, Language.getPhrase('stage_new_sprite', 'New Sprite'), 24);
		...
		var btn:PsychUIButton = new PsychUIButton(0, btnY, Language.getPhrase('stage_no_animation', 'No Animation'), function() loadImage('sprite'));
		...
		var btn:PsychUIButton = new PsychUIButton(0, btnY, Language.getPhrase('stage_animated', 'Animated'), function() loadImage('animatedSprite'));
		...
		var btn:PsychUIButton = new PsychUIButton(0, btnY, Language.getPhrase('stage_solid_color', 'Solid Color'), function() {
...

	{
		...
		tab_group.add(new FlxText(objX, objY - 18, 150, Language.getPhrase('stage_compiled_assets', 'Compiled Assets:')));
		...
		var saveButton:PsychUIButton = new PsychUIButton(UI_box.width - 90, UI_box.height - 50, Language.getPhrase('stage_save', 'Save'), function() {
		...
		tab_group.add(new FlxText(objX, objY - 18, 100, Language.getPhrase('stage_ui_style', 'UI Style:')));
		...
		hideGirlfriendCheckbox = new PsychUICheckBox(objX, objY, Language.getPhrase('stage_hide_gf', 'Hide Girlfriend?'), 100);
		...
		tab_group.add(new FlxText(objX, objY - 18, 100, Language.getPhrase('stage_camera_offsets', 'Camera Offsets:')));



		objY += 20;

		tab_group.add(new FlxText(objX, objY - 18, 100, Language.getPhrase('stage_opponent', 'Opponent:')));
		...
		tab_group.add(new FlxText(objX, objY - 18, 100, Language.getPhrase('stage_girlfriend', 'Girlfriend:')));
		...
		tab_group.add(new FlxText(objX, objY - 18, 100, Language.getPhrase('stage_boyfriend', 'Boyfriend:')));
		...
		tab_group.add(new FlxText(objX, objY - 18, 100, Language.getPhrase('stage_camera_data', 'Camera Data:')));

		objY += 20;

		tab_group.add(new FlxText(objX, objY - 18, 100, Language.getPhrase('stage_zoom', 'Zoom:')));
		...
		tab_group.add(new FlxText(objX + 80, objY - 18, 100, Language.getPhrase('stage_speed', 'Speed:')));
...

	{
		...
		tab_group.add(new FlxText(objX, objY - 18, 150, Language.getPhrase('stage_name_lua', 'Name (for Lua/HScript):')));
		...
		nameInputText.onChange = function(old:String, cur:String) {
...

			{
...

				{
					...
					showOutput(Language.getPhrase('stage_msg_name_empty', 'Sprite name cannot be empty!'), true);
...

				{
					...
					showOutput(Language.getPhrase('stage_msg_name_conflict', 'To avoid conflicts, this name cannot be used!'), true);
		...
		imgTxt = new FlxText(objX, objY - 15, 200, Language.getPhrase('stage_image', 'Image: '), 8);

		var imgButton:PsychUIButton = new PsychUIButton(objX, objY, Language.getPhrase('stage_change_image', 'Change Image'), function() {
		...
		var animationsButton:PsychUIButton = new PsychUIButton(objX + 90, objY, Language.getPhrase('stage_animations_btn', 'Animations'), function() {
...

			{
				...
				showOutput(Language.getPhrase('stage_msg_only_animated', 'Only Animated Sprites can hold Animation data.'), true);
		...
		tab_group.add(new FlxText(objX, objY - 18, 80, Language.getPhrase('stage_color', 'Color:')));
		...
		tab_group.add(new FlxText(objX, objY - 18, 100, Language.getPhrase('stage_scale_xy', 'Scale (X/Y):')));
		...
		tab_group.add(new FlxText(objX, objY - 18, 150, Language.getPhrase('stage_scroll_xy', 'Scroll Factor (X/Y):')));
		...
		antialiasingCheckbox = new PsychUICheckBox(objX + 90, objY, Language.getPhrase('stage_antialiasing', 'Anti-Aliasing'), 80);
		...
		tab_group.add(new FlxText(objX, objY - 18, 80, Language.getPhrase('stage_angle', 'Angle:')));
		...
		flipXCheckBox = new PsychUICheckBox(objX, objY, Language.getPhrase('stage_flip_x', 'Flip X'), 60);

		flipXCheckBox.onClick = updateFlip;

		flipYCheckBox = new PsychUICheckBox(objX + 90, objY, Language.getPhrase('stage_flip_y', 'Flip Y'), 60);
		...
		tab_group.add(new FlxText(objX + 60, objY - 18, 100, Language.getPhrase('stage_visible_in', 'Visible in:')));

		lowQualityCheckbox = new PsychUICheckBox(objX, objY, Language.getPhrase('stage_low_quality', 'Low Quality'), 70);

		highQualityCheckbox = new PsychUICheckBox(objX + 90, objY, Language.getPhrase('stage_high_quality', 'High Quality'), 70);
...

	{
		...
		var openPreloadButton:PsychUIButton = new PsychUIButton(objX, objY, Language.getPhrase('stage_preload_list', 'Preload List'), function() {
		...
		tab_group.add(new FlxText(gfDropdown.x, gfDropdown.y - 18, 100, Language.getPhrase('stage_girlfriend', 'Girlfriend:')));

		tab_group.add(gfDropdown);

		tab_group.add(new FlxText(oppDropdown.x, oppDropdown.y - 18, 100, Language.getPhrase('stage_opponent', 'Opponent:')));
...

	{
		...
		var reloadStage:PsychUIButton = new PsychUIButton(140, 10, Language.getPhrase('stage_reload', 'Reload'), function()
		...
		var dummyStage:PsychUIButton = new PsychUIButton(140, 40, Language.getPhrase('stage_load_template', 'Load Template'), function()

		{

			#if DISCORD_ALLOWED

			DiscordClient.changePresence(Language.getPhrase('stage_discord_title', 'Stage Editor'), 'New Stage');
...

	{
		...
		imgTxt.text = Language.getPhrase('stage_image', 'Image: ') + selected.image;
...

	{
...

		{
...

			{
...

				{
					...
					showOutput(Language.getPhrase('stage_msg_no_anim_file', 'No Animation file found with the same name of the image!'), true);
...

		{
...

			{
				...
				var btn:PsychUIButton = new PsychUIButton(0, btnY, Language.getPhrase('stage_ok', 'OK'), function() {
				...
				var btn:PsychUIButton = new PsychUIButton(0, btnY, Language.getPhrase('stage_cancel', 'Cancel'), function()
			...
			showOutput(Language.getPhrase('stage_msg_file_error', 'ERROR! File cannot be used, move it to \"assets\" and recompile.'), true);
...
class StageEditorAnimationSubstate extends MusicBeatSubstate {
...

	{
		...
		animationLoopCheckBox = new PsychUICheckBox(animationNameInputText.x + 170, animationNameInputText.y - 1, Language.getPhrase('stage_should_loop', 'Should it Loop?'), 100);
		...
		mainAnimTxt = new FlxText(160, animationDropDown.y - 18, 0, Language.getPhrase('stage_main_anim', 'Main Anim.: '));

		var initAnimButton:PsychUIButton = new PsychUIButton(160, animationDropDown.y, Language.getPhrase('stage_main_animation', 'Main Animation'), function() {
		...
		var addUpdateButton:PsychUIButton = new PsychUIButton(40, animationIndicesInputText.y + 35, Language.getPhrase('stage_add_update', 'Add/Update'), function() {
		...
		var removeButton:PsychUIButton = new PsychUIButton(160, animationIndicesInputText.y + 35, Language.getPhrase('stage_remove', 'Remove'), function()
		...
		tab_group.add(new FlxText(animationDropDown.x, animationDropDown.y - 18, 0, Language.getPhrase('stage_animations', 'Animations:')));

		tab_group.add(new FlxText(animationInputText.x, animationInputText.y - 18, 0, Language.getPhrase('stage_animation_name', 'Animation name:')));

		tab_group.add(new FlxText(animationFramerate.x, animationFramerate.y - 18, 0, Language.getPhrase('stage_framerate', 'Framerate:')));

		tab_group.add(new FlxText(animationNameInputText.x, animationNameInputText.y - 18, 0, Language.getPhrase('stage_anim_symbol', 'Animation Symbol Name/Tag:')));

		tab_group.add(new FlxText(animationIndicesInputText.x, animationIndicesInputText.y - 18, 0, Language.getPhrase('stage_anim_indices', 'ADVANCED - Animation Indices:')));
