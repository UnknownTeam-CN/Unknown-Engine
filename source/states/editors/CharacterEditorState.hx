...

{
...

	{
		...
		var tipText:FlxText = new FlxText(FlxG.width - 300, FlxG.height - 24, 300, Language.getPhrase("char_help_f1", "Press F1 for Help"), 20);
...

	{
		...
		var makeGhostButton:PsychUIButton = new PsychUIButton(25, 15, Language.getPhrase("char_make_ghost", "Make Ghost"), function() {
		...
		var highlightGhost:PsychUICheckBox = new PsychUICheckBox(20 + makeGhostButton.x + makeGhostButton.width, makeGhostButton.y, Language.getPhrase("char_highlight_ghost", "Highlight Ghost"), 100);
...

	{
		...
		check_player = new PsychUICheckBox(10, 60, Language.getPhrase("char_playable", "Playable Character"), 100);
		...
		var reloadCharacter:PsychUIButton = new PsychUIButton(140, 20, Language.getPhrase("char_reload_char", "Reload Char"), function()
		...
		var templateCharacter:PsychUIButton = new PsychUIButton(140, 50, Language.getPhrase("char_load_template", "Load Template"), function()
		...
		tab_group.add(new FlxText(charDropDown.x, charDropDown.y - 18, 80, Language.getPhrase('char_character', 'Character:')));
...

	{
		...
		animationLoopCheckBox = new PsychUICheckBox(animationNameInputText.x + 170, animationNameInputText.y - 1, Language.getPhrase("char_should_loop", "Should it Loop?"), 100);
		...
		var addUpdateButton:PsychUIButton = new PsychUIButton(70, animationIndicesInputText.y + 60, Language.getPhrase("char_add_update", "Add/Update"), function() {
		...
		var removeButton:PsychUIButton = new PsychUIButton(180, animationIndicesInputText.y + 60, Language.getPhrase("char_remove", "Remove"), function() {
		...
		tab_group.add(new FlxText(animationDropDown.x, animationDropDown.y - 18, 100, Language.getPhrase('char_animations', 'Animations:')));

		tab_group.add(new FlxText(animationInputText.x, animationInputText.y - 18, 100, Language.getPhrase('char_animation_name', 'Animation name:')));

		tab_group.add(new FlxText(animationFramerate.x, animationFramerate.y - 18, 100, Language.getPhrase('char_framerate', 'Framerate:')));

		tab_group.add(new FlxText(animationNameInputText.x, animationNameInputText.y - 18, 150, Language.getPhrase('char_anim_symbol', 'Animation Symbol Name/Tag:')));

		tab_group.add(new FlxText(animationIndicesInputText.x, animationIndicesInputText.y - 18, 170, Language.getPhrase('char_anim_indices', 'ADVANCED - Animation Indices:')));
...

	{
		...
		var reloadImage:PsychUIButton = new PsychUIButton(imageInputText.x + 210, imageInputText.y - 3, Language.getPhrase("char_reload_image", "Reload Image"), function()
		...
		var decideIconColor:PsychUIButton = new PsychUIButton(reloadImage.x, reloadImage.y + 30, Language.getPhrase("char_get_icon_color", "Get Icon Color"), function()
		...
		flipXCheckBox = new PsychUICheckBox(singDurationStepper.x + 80, singDurationStepper.y, Language.getPhrase("char_flip_x", "Flip X"), 50);
		...
		noAntialiasingCheckBox = new PsychUICheckBox(flipXCheckBox.x, flipXCheckBox.y + 40, Language.getPhrase("char_no_antialiasing", "No Antialiasing"), 80);
		...
		var saveCharacterButton:PsychUIButton = new PsychUIButton(reloadImage.x, noAntialiasingCheckBox.y + 40, Language.getPhrase("char_save", "Save Character"), function() {
		...
		tab_group.add(new FlxText(15, imageInputText.y - 18, 100, Language.getPhrase('char_image_name', 'Image file name:')));

		tab_group.add(new FlxText(15, healthIconInputText.y - 18, 100, Language.getPhrase('char_health_icon', 'Health icon name:')));

		tab_group.add(new FlxText(15, vocalsInputText.y - 18, 100, Language.getPhrase('char_vocals_postfix', 'Vocals File Postfix:')));

		tab_group.add(new FlxText(15, singDurationStepper.y - 18, 120, Language.getPhrase('char_sing_length', 'Sing Animation length:')));

		tab_group.add(new FlxText(15, scaleStepper.y - 18, 100, Language.getPhrase('char_scale', 'Scale:')));

		tab_group.add(new FlxText(positionXStepper.x, positionXStepper.y - 18, 100, Language.getPhrase('char_xy', 'Character X/Y:')));

		tab_group.add(new FlxText(positionCameraXStepper.x, positionCameraXStepper.y - 18, 100, Language.getPhrase('char_camera_xy', 'Camera X/Y:')));

		tab_group.add(new FlxText(healthColorStepperR.x, healthColorStepperR.y - 18, 100, Language.getPhrase('char_health_rgb', 'Health Bar R/G/B:')));
