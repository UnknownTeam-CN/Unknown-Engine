...

{
...

    {
        ...
        DiscordClient.changePresence(Language.getPhrase('nsplash_discord_title', 'Note Splash Editor'));
...

    {
        ...
        addButton = new PsychUIButton(20, 185, Language.getPhrase("nsplash_add_update", "Add/Update"), function()
        ...
        var removeButton:PsychUIButton = new PsychUIButton(185, 185, Language.getPhrase("nsplash_remove", "Remove"), function()
...

    {
        ...
        var reloadButton:PsychUIButton = new PsychUIButton(185, 6.8, Language.getPhrase("nsplash_reload_image", "Reload Image"), function()
        ...
        var saveButton:PsychUIButton = new PsychUIButton(20, 130, Language.getPhrase("nsplash_save", "Save"), saveSplash);

        ui.add(saveButton);



        templateButton = new PsychUIButton(20, 155, Language.getPhrase("nsplash_template", "Template"));

        ui.add(templateButton);



        var loadButton:PsychUIButton = new PsychUIButton(180, 155, Language.getPhrase("nsplash_convert_txt", "Convert TXT"), loadTxt);
        ...
        rgbText.text = Language.getPhrase("nsplash_allow_rgb", "Allow RGB?");
        ...
        pixelText.text = Language.getPhrase("nsplash_allow_pixel", "Allow Pixel?");
...

    {
        ...
        defaultButton = new PsychUICheckBox(shaderUI.x + 30, shaderUI.y + 115, Language.getPhrase("nsplash_do_not_replace", "Do not replace"), 100, () -> onCheck());
