...
class WeekEditorState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	override function create() {
		...
		txtWeekTitle.setFormat(Paths.font('pixel-latin.ttf'), 36, FlxColor.WHITE, RIGHT);
		...
		missingFileText.setFormat(Paths.font('pixel-latin.ttf'), 28, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
