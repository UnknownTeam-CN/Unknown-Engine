...
@:structInit class SaveVariables {
	...
	public var colorfulFPS:Bool = false;
	public var colorfulFPSSpeed:Float = 6;
...
class ClientPrefs {
	...
	public static function loadPrefs() {
		...
		if(Main.fpsVar != null)
		{
			...
			Main.fpsVar.setColorfulFPS(data.colorfulFPS);
			Main.fpsVar.setColorfulFPSSpeed(data.colorfulFPSSpeed);
			Main.fpsVar.showExtraInfo = true; // 附加信息永远开启
		}
